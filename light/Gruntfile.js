module.exports = function(grunt) {
    grunt.initConfig({
        ...
        uglify: {
          my_target: {
            files: {
                'assets/bundles/libscripts.bundle.js':      ['../assets/plugins/jquery/jquery-v3.3.1.min.js','../assets/plugins/bootstrap/js/popper.min.js','../assets/plugins/bootstrap/js/bootstrap.js'], /* main js*/
                'assets/bundles/vendorscripts.bundle.js':   ['../assets/plugins/bootstrap-select/js/bootstrap-select.js','../assets/plugins/jquery-slimscroll/jquery.slimscroll.js','../assets/plugins/node-waves/waves.js','../assets/plugins/jquery-sparkline/jquery.sparkline.js','../assets/plugins/jquery-countto/jquery.countTo.js'], /* coman js*/
                ...
                'assets/bundles/jvectormap.bundle.js':      ['../assets/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js','../assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js'], /* jvectormap js*/
